...
/*!
* @nutui/nutui v3.1.12 Fri Dec 17 2021 00:23:08 GMT+0800 (中国标准时间)
* (c) 2021 @jdf2e.
...
(function(global, factory) {
  ...
  const _hoisted_7$a = /* @__PURE__ */ vue.createElementVNode("div", { class: "move-handle" }, null, -1);
  const _hoisted_8$7 = [
    _hoisted_7$a
  ];
  const _hoisted_9$6 = {
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("view", {
          ...
          _ctx.showPop ? (vue.openBlock(), vue.createBlock(_component_nut_swiper, {
            ...
            default: vue.withCtx(() => [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.videos, (item, index) => {
  ...
  function _sfc_render$I(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("view", {
        ...
        _ctx.$slots.rightin ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_5$b, [
          vue.renderSlot(_ctx.$slots, "rightin")
        ])) : vue.createCommentVNode("", true)
      ], 4),
      _ctx.$slots.rightout ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_6$8, [
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("div", {
        ...
        vue.renderSlot(_ctx.$slots, "btn", {}, () => [
          ...
          vue.createElementVNode("view", _hoisted_6$7, vue.toDisplayString(_ctx.visible ? _ctx.activeText : _ctx.unActiveText), 1)
        ])
      ])
    ], 6);
  }
  ...
  const _hoisted_5$8 = { class: "calendar-loading-tip" };
  const _hoisted_6$6 = { class: "calendar-month-title" };
  const _hoisted_7$6 = { class: "calendar-month-con" };
        ...
        vue.createElementVNode("view", _hoisted_4$d, [
          ...
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.monthsData, (month, index) => {
            return vue.openBlock(), vue.createElementBlock("view", {
              ...
              vue.createElementVNode("view", _hoisted_6$6, vue.toDisplayString(month.title), 1),
  ...
  const _sfc_main$y = create$y({
    ...
    setup(props, { emit, slots }) {
      ...
      const renderLabel = () => {
        var _a;
        return vue.h("view", {
          class: `${componentName$q}__label ${pDisabled.value ? `${componentName$q}__label--disabled` : ""}`
        }, (_a = slots.default) == null ? void 0 : _a.call(slots));
      };
      const handleClick = (e) => {
        var _a;
      ...
      return () => {
        return vue.h("view", {
          class: `${componentName$q} ${props.textPosition === "left" ? `${componentName$q}--reverse` : ""}`,
          onClick: handleClick
  ...
  const _sfc_main$r = create$r({
    ...
    setup(props, { emit, slots }) {
      ...
      const renderLabel = () => {
        var _a;
        return vue.h("view", {
          class: `${componentName$k}__label ${props.disabled ? `${componentName$k}__label--disabled` : ""}`
        }, (_a = slots.default) == null ? void 0 : _a.call(slots));
      };
      const renderButton = () => {
        var _a;
        return vue.h("view", {
          class: `${componentName$k}__button ${isCurValue.value && `${componentName$k}__button--active`} ${props.disabled ? `${componentName$k}__button--disabled` : ""}`
        }, (_a = slots.default) == null ? void 0 : _a.call(slots));
      };
      const handleClick = () => {
      ...
      return () => {
        return vue.h("view", {
          class: `${componentName$k} ${componentName$k}--${props.shape} ${reverseState ? `${componentName$k}--reverse` : ""}`,
          onClick: handleClick
        }, [
  ...
  const _sfc_main$q = create$q({
    ...
    setup(props, { emit, slots }) {
      ...
      return () => {
        var _a;
        return vue.h("view", {
          class: `${componentName$j} ${componentName$j}--${props.direction}`
        }, (_a = slots.default) == null ? void 0 : _a.call(slots));
      };
    }
  });
    ...
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.count, (n) => {
        return vue.openBlock(), vue.createElementBlock("view", {
          ...
          }, null, 8, ["font-class-name", "class-prefix", "color", "size", "name"])) : _ctx.allowHalf && _ctx.modelValue + 1 < n ? (vue.openBlock(), vue.createBlock(_component_nut_icon, {
            key: 1,
  ...
  const _hoisted_6$5 = { class: "nut-shortpsd-message" };
  const _hoisted_7$5 = { class: "nut-shortpsd-error" };
  const _hoisted_8$5 = {
    key: 0,
    ...
    return vue.openBlock(), vue.createElementBlock("view", null, [
      vue.createVNode(_component_nut_popup, {
        ...
        default: vue.withCtx(() => [
            ...
            vue.createElementVNode("view", {
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(new Array(_ctx.comLen), (sublen, index) => {
                return vue.openBlock(), vue.createElementBlock("view", {
                  ...
                  String(_ctx.realInput).length > index ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_5$7)) : vue.createCommentVNode("", true)
                ]);
              }), 128))
            ])
          ]),
          vue.createElementVNode("view", _hoisted_6$5, [
            vue.createElementVNode("view", _hoisted_7$5, vue.toDisplayString(_ctx.errorMsg), 1),
            _ctx.tips ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_8$5, [
              vue.createVNode(_component_nut_icon, {
                class: "icon",
                size: "11px",
                name: "tips"
          ...
          !_ctx.noButton ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_9$4, [
            vue.createElementVNode("view", {
  ...
  const _hoisted_6$4 = { class: "nut-uploader__preview__progress__msg" };
  const _hoisted_7$4 = {
    key: 1,
    class: "nut-uploader__preview__progress"
  };
  const _hoisted_8$4 = { class: "nut-uploader__preview__progress__msg" };
        ...
        return vue.openBlock(), vue.createElementBlock("view", {
          ...
          _ctx.listType == "picture" && !_ctx.$slots.default ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_4$b, [
            item.status == "ready" ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_5$6, [
              ...
              vue.createElementVNode("view", _hoisted_8$4, vue.toDisplayString(item.message), 1)
            ])) : vue.createCommentVNode("", true),
            ...
            item.type.includes("image") && item.url ? (vue.openBlock(), vue.createElementBlock("img", {
              ...
              src: item.url
            }, null, 8, _hoisted_9$3)) : (vue.openBlock(), vue.createElementBlock("view", _hoisted_10$2, [
              vue.createElementVNode("view", {
                onClick: ($event) => _ctx.fileItemClick(item),
              ...
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.keysList, (item) => {
                return vue.openBlock(), vue.createElementBlock("div", {
                  ...
                  vue.createElementVNode("div", {
                    ...
                    item.type == "lock" ? (vue.openBlock(), vue.createElementBlock("img", _hoisted_7$3)) : vue.createCommentVNode("", true),
                    item.type == "delete" ? (vue.openBlock(), vue.createElementBlock("img", _hoisted_8$3)) : vue.createCommentVNode("", true)
                  ], 42, _hoisted_6$3)
                ], 2);
              }), 128))
            ]),
            _ctx.type == "rightColumn" ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_9$2, [
  ...
  function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      _ctx.slots.default ? vue.renderSlot(_ctx.$slots, "default", { key: 0 }) : _ctx.showPlainText ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_1$g, vue.toDisplayString(_ctx.plainText), 1)) : (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 2 }, [
        ...
        _hoisted_7$2,
        vue.createElementVNode("view", _hoisted_8$2, vue.toDisplayString(_ctx.resttime.s), 1)
      ], 64))
    ], 2);
  }
  ...
  const _hoisted_1$a = { class: "nut-address" };
  const _hoisted_2$9 = { class: "nut-address__header" };
  const _hoisted_3$8 = { class: "nut-address__header__title" };
  const _hoisted_4$7 = {
    key: 0,
    class: "custom-address"
  };
  const _hoisted_5$3 = { class: "region-tab" };
  const _hoisted_6$1 = ["onClick"];
  const _hoisted_7$1 = { class: "region-con" };
  const _hoisted_8$1 = { class: "region-group" };
    ...
    return vue.openBlock(), vue.createBlock(_component_nut_popup, {
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("view", _hoisted_1$a, [
          vue.createElementVNode("view", _hoisted_2$9, [
            vue.createElementVNode("view", {
              class: "arrow-back",
            ...
            vue.createElementVNode("view", _hoisted_3$8, vue.toDisplayString(_ctx.privateType == "custom" ? _ctx.customAddressTitle : _ctx.existAddressTitle), 1),
            vue.createElementVNode("view", {
              class: "arrow-close",
          ...
          _ctx.privateType == "custom" ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_4$7, [
            ...
            vue.createElementVNode("view", _hoisted_7$1, [
              vue.createElementVNode("ul", _hoisted_8$1, [
  ...
  var Address = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$b]]);
  const { componentName: componentName$9, create: create$a } = createComponent("barrage");
  const _sfc_main$a = create$a({
    props: {
      danmu: {
        type: Array,
  ...
  function _sfc_render$a(_ctx, _cache, $props, $setup, $data, $options) {
    return vue.openBlock(), vue.createElementBlock("view", {
      ...
      vue.createElementVNode("view", _hoisted_1$9, null, 512)
    ], 2);
  }
  var Barrage = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a]]);
  const { componentName: componentName$8, create: create$9 } = createComponent("signature");
  ...
  const _hoisted_2$8 = ["height", "width"];
  const _hoisted_3$7 = {
    key: 1,
    class: "nut-signature-unsopport"
  };
  const _hoisted_4$6 = /* @__PURE__ */ vue.createTextVNode("\u91CD\u7B7E");
  const _hoisted_5$2 = /* @__PURE__ */ vue.createTextVNode("\u786E\u8BA4");
  function _sfc_render$9(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("div", {
      ...
      vue.createElementVNode("div", _hoisted_1$8, [
        ...
        }, null, 8, _hoisted_2$8)) : (vue.openBlock(), vue.createElementBlock("p", _hoisted_3$7, vue.toDisplayString(_ctx.unSupportTpl), 1))
      ], 512),
  ...
  var Signature = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9]]);
  const { componentName: componentName$7, create: create$8 } = createComponent("timeselect");
  ...
  const _hoisted_1$7 = { class: "nut-timeselect__title" };
  const _hoisted_2$7 = { class: "nut-timeselect__title__fixed" };
  const _hoisted_3$6 = { class: "nut-timeselect__content" };
  const _hoisted_4$5 = { class: "nut-timeselect__content__pannel" };
  const _hoisted_5$1 = { class: "nut-timeselect__content__detail" };
      ...
      default: vue.withCtx(() => [
        vue.createElementVNode("view", {
          ...
          vue.createElementVNode("view", _hoisted_1$7, [
            vue.createElementVNode("view", _hoisted_2$7, vue.toDisplayString(_ctx.title), 1)
          ]),
  ...
  var TimeSelect = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$8]]);
  const { componentName: componentName$6, create: create$7 } = createComponent("timepannel");
  ...
  var TimePannel = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$7]]);
  const { componentName: componentName$5, create: create$6 } = createComponent("timedetail");
  ...
  const _hoisted_1$6 = { class: "nut-timedetail__detail nut-timedetail__detail--moring" };
  const _hoisted_2$6 = { class: "nut-timedetail__detail__list" };
      ...
      vue.createElementVNode("view", _hoisted_1$6, [
        vue.createElementVNode("view", _hoisted_2$6, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.renderData, (item) => {
            ...
            }, vue.toDisplayString(item), 11, _hoisted_3$5);
          }), 128))
        ])
      ])
    ], 2);
  }
  var TimeDetail = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6]]);
  const { componentName: componentName$4, create: create$5 } = createComponent("sku-header");
  ...
  const _hoisted_1$5 = { class: "nut-sku-header" };
  const _hoisted_2$5 = ["src"];
  const _hoisted_3$4 = { class: "nut-sku-header-right" };
  const _hoisted_4$4 = {
    key: 3,
  ...
  function _sfc_render$5(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", _hoisted_1$5, [
      ...
      vue.createElementVNode("view", _hoisted_3$4, [
        ...
        _ctx.goods.skuId && !_ctx.getSlots("sku-header-extra") ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_4$4, "\u5546\u54C1\u7F16\u53F7\uFF1A" + vue.toDisplayString(_ctx.goods.skuId), 1)) : vue.createCommentVNode("", true)
      ])
    ]);
  }
  var SkuHeader = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5]]);
  const { componentName: componentName$3, create: create$4 } = createComponent("sku-select");
  ...
  const _hoisted_1$4 = { class: "nut-sku-select" };
  const _hoisted_2$4 = { class: "nut-sku-select-item-title" };
  const _hoisted_3$3 = { class: "nut-sku-select-item-skus" };
          ...
          vue.createElementVNode("view", _hoisted_3$3, [
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(item.list, (itemAttr, itemAttrIndex) => {
              return vue.openBlock(), vue.createElementBlock("view", {
                ...
                key: itemAttr.name
              }, vue.toDisplayString(itemAttr.name), 11, _hoisted_4$3);
            }), 128))
          ])
        ]);
      }), 128))
  ...
  var SkuSelect = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4]]);
  const { componentName: componentName$2, create: create$3 } = createComponent("sku-stepper");
  ...
  const _hoisted_1$3 = { class: "nut-sku-stepper" };
  const _hoisted_2$3 = { class: "nut-sku-stepper-title" };
  const _hoisted_3$2 = ["innerHTML"];
  const _hoisted_4$2 = { class: "nut-sku-stepper-count" };
  function _sfc_render$3(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return vue.openBlock(), vue.createElementBlock("view", _hoisted_1$3, [
      vue.createElementVNode("view", _hoisted_2$3, vue.toDisplayString(_ctx.stepperTitle), 1),
      vue.createElementVNode("view", {
  ...
  var SkuStepper = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3]]);
  const { componentName: componentName$1, create: create$2 } = createComponent("sku-operate");
  ...
  function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
    return _ctx.btnOptions.length > 0 ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_1$2, [
      ...
      !_ctx.getSlots("operate-btn") ? (vue.openBlock(), vue.createElementBlock("view", _hoisted_3$1, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.btnOptions, (btn, i) => {
          ...
          }, vue.toDisplayString(_ctx.getBtnDesc(btn)), 11, _hoisted_4$1);
        }), 128))
      ])) : vue.createCommentVNode("", true)
    ])) : vue.createCommentVNode("", true);
  }
  var SkuOperate = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2]]);
  const { componentName, create: create$1 } = createComponent("sku");
  ...
  const _hoisted_1$1 = { class: "nut-sku" };
  const _hoisted_2$1 = { class: "nut-sku-content" };
  ...
  var Sku = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["render", _sfc_render$1]]);
